#!/usr/bin/env python3
"""Recuento de la produccion de Francisca Julian Querol repartida por los cuatro proyectos.

Lee los repositorios hermanos clonados al lado de este (por defecto ~/IdeaProjects) y escribe
...
ARREL_PER_DEFECTE = Path.home() / "IdeaProjects"
DESTI = Path(__file__).resolve().parent.parent / "content" / "metriques.json"
